...
public class TestUnitaireTriInsertion
{
  ...
  public void tableau_vide()
  {
    ...
    // trier le tableau a_tester
    AppelAlgoTri(a_tester);
  ...
  public void tableau_quelconque()
  {
    ...
    int [] oracle = Arrays.copyOf(a_tester, a_tester.length); 
  ...
  public void tableau_hasard()
  {
    ...
    int [] a_tester = initialiserTableau(nbElements);
    int [] oracle = Arrays.copyOf(a_tester, a_tester.length);
    AppelAlgoTri(a_tester);
    Arrays.sort(oracle);
    Assert.assertArrayEquals(oracle, a_tester);
