...
public class AbonneOperateur implements GestionCommunication
{
  ...
  // renvoie numéro de téléphone de l'abonné
  public NumeroTelephone getNum(){return num;}
  
  
  // renvoie le téléphone de l'abonné
  public Telephone getTel(){return tel;}
  
  
  //  renvoie la boiteSMS de l'abonné
  public BoiteSMS getBoiteSMS(){return b1;}
  
  
  // renvoie la boiteVocale de l'abonné
  public BoiteVocale getBoiteVocale(){return b2;}
  
  
  // renvoie la durée de l'appel
  ...
  // renvoie le forfait de l'abonné
  ...
  // compte le nombre de fois où l'abonné consulte la messagerie
  ...
  public void synchroniser()
  {
	  ...
	  //Tant que tous les messages n'ont pas été lus
	  while (i != a){
		  MessageSMS message = this.b1.getNouveauSMS(); //on recupere les message situés sur le serveur
		  this.tel.getBoite().ajouterSMS(message); //envoi au téléphone
		  i++;
	  }
  }
