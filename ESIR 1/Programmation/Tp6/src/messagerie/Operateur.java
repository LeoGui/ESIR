 ...
 */
  ...
  public void posterSMS(AbonneOperateur emetteur, String numeroDestinataire, String sms, Date dateEnvoi){
	  ...
	  //Tant qu'on a pas atteint le max de la liste et tant qu'on a pas trouvé l'abonné en question.
	  while ( (i<liste.size()) && (!numeroDestinataire.equals(liste.get(i).getNum().getNum()))) {

		  //si le recepteur fait partie de la liste des abonnés
  ...
  public void cloreAppel(AbonneOperateur abonne, Date fin){
	  ...
	  appel.terminerAppel(fin); //terminer l'appel et l'appel s'est terminé à la date fin 
  }
  
  
  //permet de renvoyer la facture de l'abonné
  ...
  public double getMontantCom(AbonneOperateur abonne){
	  ...
	  //si le forfait est : "illimité"
	  if (forfait.equals("illimité")){montanttotal = 40;}
  ...
  //renvoie l'abonne en fonction du numéro
